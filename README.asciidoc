...
bean-validation      ee                   hibernate-validator  jaxrs-multipart      jmx                  keycloak             messaging            ribbon               transactions         
connector            ejb                  infinispan           jaxrs-weld           jolokia              logging              msc                  ribbon-secured       undertow             
container            ejb-remote           jaxrs-jaxb           jca                  jpa                  logstash             naming               ribbon-webapp        webservices          
datasources          hawkular             jaxrs-jsonp          jgroups              jsf                  mail                 remoting             security             weld                 
----
+
