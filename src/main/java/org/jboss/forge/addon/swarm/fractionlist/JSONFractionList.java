...
/**
 * TODO: Move this code to wildfly-swarm core (SWARM-1000)
 * 
 * @author <a href="mailto:ggastald@redhat.com">George Gastaldi</a>
 */
public class JSONFractionList implements FractionList
{
   ...
   public JSONFractionList(String version, InputStream fractionListJSON, InputStream fractionPackagesProperties)
            throws IOException
   {
      ...
      packageSpecs.putAll((Map) PropertiesUtil.loadProperties(fractionPackagesProperties));
   }
